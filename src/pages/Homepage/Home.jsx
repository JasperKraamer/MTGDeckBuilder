function Home() {
    return (
        <main className="background">
            ...
            <section className="text-left">The latest news about Magic the Gathering</section>
            <section className="text-right">
                <h1 className="about">About this application</h1>
                With this application you will be able to find all avalible magic the gathering cards.
